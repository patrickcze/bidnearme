//
//  NewGroupTitleViewController.swift
//  Lulu
//
...
class NewGroupTitleViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "WizardStepThree" {
            let destinationController = segue.destination as! NewGroupMembersViewController
...
extension NewGroupTitleViewController: UITextFieldDelegate {
